   ...
   masterDetailView: SC.MasterDetailView.design({
     ...
     detailView: SC.WorkspaceView.extend({
       ...
       topToolbar: SC.ToolbarView.extend({
         ...
         childViews: "actionsButton displayModeSegments masterPickerButton welcomeMessageLabel filterPanelButton filterCancelButton tasksSearchField tasksSearchCancelButton".w(),
         classNames: ['title-bar'],
         ...
         tasksSearchField: SC.TextFieldView.design(SCUI.ToolTip, {
           layout: { centerY: 0, height: 25, right: 5, width: 200 },
